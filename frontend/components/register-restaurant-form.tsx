...
import { createRestaurant, updateDaysOff, updateRestaurantHours, updateRestaurantInfo } from '../apis/restaurant.api';
  ...
  function onSuccessAlertClose() {
   ...
   const handleSubmit = async () => {
    ...
    try {
      ...
      const payloadWithImages = {...payload, images: uploadedUrls, id: restaurantId};

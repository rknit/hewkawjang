    ...
    <Modal visible={visible} transparent animationType="slide">
      ...
      >
        ...
        >
          <ScrollView className="flex-1">
            ...
            <View className="mb-2">
              ...
              >
                <Calendar
                  ...
                  markedDates={{
                    [date]: { selected: true, selectedColor: brand.primary },
                  }}
                  theme={{
                      ...
                      <ScrollView style={{ maxHeight: 300 }}>
                        {validMinutes.map((m) => (
                          <TouchableOpacity
                            ...
                            style={{
                              backgroundColor:
                                m === minute ? brand.primary : brand.surface,
                            }}
                          >
                            <Text
                              className="text-lg"
                              style={{
                                color: m === minute ? '#ffffff' : brand.text,
            ...
            >
              ...
              <View className="flex-row justify-between">
                <Text className="text-base" style={{ color: brand.subtext }}>
                  {totalGuests} {totalGuests === 1 ? 'Guest' : 'Guests'}
                </Text>
              </View>
              <Text className="text-base mt-1" style={{ color: brand.subtext }}>
          ...
          >
            <Text className="font-bold text-white text-lg">Reserve</Text>
          </TouchableOpacity>
        </TouchableOpacity>
      </TouchableOpacity>
    </Modal>

...
// Logout
router.post('/logout', auth_middleware_1.authClientTypeHandler, auth_middleware_1.authHandler, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.userAuthPayload) {
        throw http_errors_1.default.Unauthorized('User not authenticated');
    }
    yield auth_service_1.default.logoutUser(req.userAuthPayload);
